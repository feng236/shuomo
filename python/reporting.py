...
FIELD_CN = {
    ...
    "offgrid_annual_cost": "离网全年成本(元)",
    "grid_connected_annual_cost": "联网全年成本(元)",
    "offgrid_annual_unit_cost": "离网全年吨氨成本(元/吨)",
    "grid_connected_annual_unit_cost": "联网全年吨氨成本(元/吨)",
    ...
    "target_daily_NH3_t": "同产量需求(吨/日)",
    "offgrid_daily_cost": "离网日成本(元)",
    "grid_connected_daily_cost": "联网日成本(元)",
    ...
    "grid_support_value_daily": "电网支撑日价值(元)",
    "annual_weight_days": "年化权重天数",
    "grid_support_value_annual": "电网支撑全年价值(元)",
    "grid_support_value_yuan_per_t": "电网支撑价值(元/吨)",
